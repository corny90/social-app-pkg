...
var file_grpc_proto_message_proto_rawDesc = []byte{
	...
	0x63, 0x69, 0x70, 0x69, 0x65, 0x6e, 0x74, 0x32, 0xa1, 0x09, 0x0a, 0x0e, 0x4d, 0x65, 0x73, 0x73,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x72, 0x0a, 0x19, 0x46, 0x65, 0x74, 0x63, 0x68, 0x43, 0x6f, 0x6e,
	0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	0x73, 0x12, 0x29, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x46, 0x65, 0x74, 0x63,
	0x68, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2a, 0x2e, 0x6d,
	...
	0x73, 0x74, 0x1a, 0x23, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x44, 0x65, 0x6c,
	0x65, 0x74, 0x65, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52,
	...
	0x69, 0x6f, 0x6e, 0x73, 0x12, 0x29, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x46,
	0x65, 0x74, 0x63, 0x68, 0x41, 0x6c, 0x6c, 0x55, 0x73, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x76, 0x65,
	0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x2a, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x46, 0x65, 0x74, 0x63, 0x68, 0x41,
	0x6c, 0x6c, 0x55, 0x73, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x18, 0x5a, 0x16, 0x2f,
	0x67, 0x72, 0x70, 0x63, 0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x3b, 0x67, 0x72, 0x70, 0x63, 0x5f,
...
var file_grpc_proto_message_proto_msgTypes = make([]protoimpl.MessageInfo, 33)
var file_grpc_proto_message_proto_goTypes = []any{
	...
	(*ChatbotMessageRequest)(nil),             // 22: message.ChatbotMessageRequest
	(*ChatbotMessageResponse)(nil),            // 23: message.ChatbotMessageResponse
	(*CreateTaskMessageRequest)(nil),          // 24: message.CreateTaskMessageRequest
	(*CreateTaskMessageResponse)(nil),         // 25: message.CreateTaskMessageResponse
	(*CompleteTaskMessageRequest)(nil),        // 26: message.CompleteTaskMessageRequest
	(*CompleteTaskMessageResponse)(nil),       // 27: message.CompleteTaskMessageResponse
	(*ConversationRender)(nil),                // 28: message.ConversationRender
	(*Participant)(nil),                       // 29: message.Participant
	(*Conversation)(nil),                      // 30: message.Conversation
	(*Message)(nil),                           // 31: message.Message
	(*TaskData)(nil),                          // 32: message.TaskData
}
var file_grpc_proto_message_proto_depIdxs = []int32{
	31, // 0: message.CustomerMessageResponse.message:type_name -> message.Message
	31, // 1: message.UserSendMessageResponse.userMessage:type_name -> message.Message
	31, // 2: message.UserSendMessageResponse.botMessage:type_name -> message.Message
	31, // 3: message.FetchMessageResponse.message:type_name -> message.Message
	31, // 4: message.FetchConversationMessagesResponse.messages:type_name -> message.Message
	28, // 5: message.FetchAllUserConversationsResponse.conversations:type_name -> message.ConversationRender
	31, // 6: message.ChatbotMessageRequest.message:type_name -> message.Message
	32, // 7: message.CreateTaskMessageRequest.taskData:type_name -> message.TaskData
	32, // 8: message.CompleteTaskMessageRequest.taskData:type_name -> message.TaskData
	29, // 9: message.ConversationRender.participants:type_name -> message.Participant
	...
	22, // 12: message.MessageService.ChatbotMessage:input_type -> message.ChatbotMessageRequest
	2,  // 13: message.MessageService.PingTasksQueue:input_type -> message.PingTasksQueueRequest
	24, // 14: message.MessageService.CreateTaskMessage:input_type -> message.CreateTaskMessageRequest
	26, // 15: message.MessageService.CompleteTaskMessage:input_type -> message.CompleteTaskMessageRequest
	...
	16, // 20: message.MessageService.FetchConversationMessages:input_type -> message.FetchConversationMessagesRequest
	18, // 21: message.MessageService.DeleteConversation:input_type -> message.DeleteConversationRequest
	20, // 22: message.MessageService.FetchAllUserConversations:input_type -> message.FetchAllUserConversationsRequest
	...
	23, // 25: message.MessageService.ChatbotMessage:output_type -> message.ChatbotMessageResponse
	3,  // 26: message.MessageService.PingTasksQueue:output_type -> message.PingTasksQueueResponse
	25, // 27: message.MessageService.CreateTaskMessage:output_type -> message.CreateTaskMessageResponse
	27, // 28: message.MessageService.CompleteTaskMessage:output_type -> message.CompleteTaskMessageResponse
	...
	17, // 33: message.MessageService.FetchConversationMessages:output_type -> message.FetchConversationMessagesResponse
	19, // 34: message.MessageService.DeleteConversation:output_type -> message.DeleteConversationResponse
	21, // 35: message.MessageService.FetchAllUserConversations:output_type -> message.FetchAllUserConversationsResponse
