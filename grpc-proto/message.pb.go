...
var file_grpc_proto_message_proto_rawDesc = []byte{
	...
	0x63, 0x69, 0x70, 0x69, 0x65, 0x6e, 0x74, 0x32, 0xeb, 0x09, 0x0a, 0x0e, 0x4d, 0x65, 0x73, 0x73,
...
var file_grpc_proto_message_proto_depIdxs = []int32{
	...
	1,  // 24: message.MessageService.PingApiMessage:output_type -> message.PingApiMessageResponse
	5,  // 25: message.MessageService.CustomerMessage:output_type -> message.CustomerMessageResponse
	23, // 26: message.MessageService.ChatbotMessage:output_type -> message.ChatbotMessageResponse
	3,  // 27: message.MessageService.PingTasksQueue:output_type -> message.PingTasksQueueResponse
	25, // 28: message.MessageService.CreateTaskMessage:output_type -> message.CreateTaskMessageResponse
	27, // 29: message.MessageService.CompleteTaskMessage:output_type -> message.CompleteTaskMessageResponse
	7,  // 30: message.MessageService.UserSendMessage:output_type -> message.UserSendMessageResponse
	9,  // 31: message.MessageService.EditMessage:output_type -> message.EditMessageResponse
	11, // 32: message.MessageService.FetchMessage:output_type -> message.FetchMessageResponse
	13, // 33: message.MessageService.DeleteMessage:output_type -> message.DeleteMessageResponse
	15, // 34: message.MessageService.ReadMessage:output_type -> message.ReadMessageResponse
	17, // 35: message.MessageService.FetchConversationMessages:output_type -> message.FetchConversationMessagesResponse
	19, // 36: message.MessageService.DeleteConversation:output_type -> message.DeleteConversationResponse
	21, // 37: message.MessageService.FetchAllUserConversations:output_type -> message.FetchAllUserConversationsResponse
